...
const Tools = {
  ...
  insertSymbol(x){ const el=document.querySelector('.cbt-free-answer') || this.active || document.activeElement; if(el && ('value' in el)){ const a=el.selectionStart||0,b=el.selectionEnd||0; el.value=el.value.slice(0,a)+x+el.value.slice(b); el.focus(); el.selectionStart=el.selectionEnd=a+x.length; if(typeof Exam!=='undefined') Exam.answer(el.value); } },
  calcPress(b){
